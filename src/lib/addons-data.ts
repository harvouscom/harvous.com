    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Joining a shared space is free for members. Hosting — creating spaces for your group — is included with [Harvous Plus](/pricing/) ($7/mo or $49/yr; $35 for the first 99, first year only).",
        ],
      },
      {
